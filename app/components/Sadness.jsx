...
class Sadness extends React.Component {
  constructor(props) {
    ...
    this.posTwo = this.posTwo.bind(this)
  }
      ...
      <Scene fog="type: linear; color: #AAB; far: 30; near: ">
        ...
        <Entity text={{value: this.state.splitStory[2], align: 'center'}} position={{x: -24.6, y: 2, z: 3.318}} rotation={{x: 0, y: 61.3, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[2] && charNameArr[0] && this.state.splitStory[2].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(-24.6, 2, 3.318)} src={this.props.characters[charNameArr[0]]} rotation="0 61.3 0" height="1" width="1"/>
        }
        {this.state.splitStory[2] && charNameArr[1] && this.state.splitStory[2].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(-24.6, 2, 3.318)} rotation={{x: 0, y: 61.3, z: 0}} src={this.props.characters[charNameArr[1]]} height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[3], align: 'center'}} position={{x: -26.8, y: 1.327, z: -5.21}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[3] && charNameArr[0] && this.state.splitStory[3].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="-25.6 1.327 -5.21" src={this.props.characters[charNameArr[0]]} height="1" width="1"/>
        }
        {this.state.splitStory[3] && charNameArr[1] && this.state.splitStory[3].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={"-27.6 1.327 -3.76"} src={this.props.characters[charNameArr[1]]} height="1" width="1"/>
        }
        {this.state.splitStory[3] && charNameArr[2] && this.state.splitStory[3].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="6 5 0" src={this.props.characters[charNameArr[2]]} height="1" width="1"/>
        }
        {this.state.splitStory[3] && charNameArr[3] && this.state.splitStory[3].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="6 7 0" src={this.props.characters[charNameArr[3]]} height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[4], align: 'center'}} position={{x: -19.5, y: 0.935, z: -10.2}} rotation={{x: 0, y: -21.887, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[4] && charNameArr[0] && this.state.splitStory[4].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="-23.1 0.935 -10.2" src={this.props.characters[charNameArr[0]]} rotation="0 -21.887 0" height="1" width="1"/>
        }
        {this.state.splitStory[4] && charNameArr[1] && this.state.splitStory[4].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(-19.5, 0.935, -10.25)} src={this.props.characters[charNameArr[1]]} rotation="0 -21.887 0" height="1" width="1"/>
        }
        {this.state.splitStory[4] && charNameArr[2] && this.state.splitStory[4].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="8 5 0" src={this.props.characters[charNameArr[2]]} rotation="0 -21.887 0" height="1" width="1"/>
        }
        {this.state.splitStory[4] && charNameArr[3] && this.state.splitStory[4].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="8 7 0" src={this.props.characters[charNameArr[3]]} rotation="0 -21.887 0" height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[5], align: 'center'}} position={{x: -8.45, y: 2, z: -3.92}} rotation={{x: 0, y: -130, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[5] && charNameArr[0] && this.state.splitStory[5].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="-8.45 2 -6.7" src={this.props.characters[charNameArr[0]]} rotation="0 -130 0" height="1" width="1"/>
        }
        {this.state.splitStory[5] && charNameArr[1] && this.state.splitStory[5].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(-8.45, 2, -3.92)} rotation={{x: 0, y: -130, z: 0}} src={this.props.characters[charNameArr[1]]} rotation="0 -130 0" height="1" width="1"/>
        }
        {this.state.splitStory[5] && charNameArr[2] && this.state.splitStory[5].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="10 5 0" src={this.props.characters[charNameArr[2]]} rotation="0 -130 0" height="1" width="1"/>
        }
        {this.state.splitStory[5] && charNameArr[3] && this.state.splitStory[5].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="10 7 0" src={this.props.characters[charNameArr[3]]} rotation="0 -130 0" height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[6], align: 'center'}} position={{x: 6.777, y: 2, z: -9.39}} rotation={{x: 0, y: -67.27, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[6] && charNameArr[0] && this.state.splitStory[6].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(6.777, 2, -9.39)} src={this.props.characters[charNameArr[0]]} rotation="0 -67.27 0" height="1" width="1"/>
        }
        {this.state.splitStory[6] && charNameArr[1] && this.state.splitStory[6].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(6.777, 2, -9.39)} rotation={{x: 0, y: -67.27, z: 0}}src={this.props.characters[charNameArr[1]]} rotation="0 -67.27 0" height="1" width="1"/>
        }
        {this.state.splitStory[6] && charNameArr[2] && this.state.splitStory[6].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="12 5 0" src={this.props.characters[charNameArr[2]]} rotation="0 -67.27 0" height="1" width="1"/>
        }
        {this.state.splitStory[6] && charNameArr[3] && this.state.splitStory[6].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="12 7 0" src={this.props.characters[charNameArr[3]]} rotation="0 -67.27 0" height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[7], align: 'center'}} position={{x: 16.66, y: 4.801, z: 3.738}} rotation={{x: 0, y: -139, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[7] && charNameArr[0] && this.state.splitStory[7].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(16.66, 4.801, 3.738)} src={this.props.characters[charNameArr[0]]} rotation="0 -139 0" height="1" width="1"/>
        }
        {this.state.splitStory[7] && charNameArr[1] && this.state.splitStory[7].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(16.66, 4.801, 3.738)} rotation={{x: 0, y: -139, z: 0}} src={this.props.characters[charNameArr[1]]} rotation="0 -139 0" height="1" width="1"/>
        }
        {this.state.splitStory[7] && charNameArr[2] && this.state.splitStory[7].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="14 5 0" src={this.props.characters[charNameArr[2]]} rotation="0 -139 0" height="1" width="1"/>
        }
        {this.state.splitStory[7] && charNameArr[3] && this.state.splitStory[7].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="14 7 0" src={this.props.characters[charNameArr[3]]} rotation="0 -139 0" height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[8], align: 'center'}} position={{x: 11.53, y: 4.639, z: 14.21}} rotation={{x: 0, y: 150.4, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[8] && charNameArr[0] && this.state.splitStory[8].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(11.53, 4.639, 14.21)} src={this.props.characters[charNameArr[0]]} rotation="0 150 0" height="1" width="1"/>
        }
        {this.state.splitStory[8] && charNameArr[1] && this.state.splitStory[8].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(11.53, 4.639, 14.21)} rotation={{x: 0, y: 150.4, z: 0}} src={this.props.characters[charNameArr[1]]} rotation="0 150 0" height="1" width="1"/>
        }
        {this.state.splitStory[8] && charNameArr[2] && this.state.splitStory[8].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="16 5 0" src={this.props.characters[charNameArr[2]]} rotation="0 150 0" height="1" width="1"/>
        }
        {this.state.splitStory[8] && charNameArr[3] && this.state.splitStory[8].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="16 7 0" src={this.props.characters[charNameArr[3]]} rotation="0 150 0" height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[9], align: 'center'}} position={{x: 5.329, y: 4.976, z: 20.04}} rotation={{x: 0, y: -180, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[9] && charNameArr[0] && this.state.splitStory[9].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(5.329, 4.976, 20.04)} src={this.props.characters[charNameArr[0]]} rotation="0-180 0" height="1" width="1"/>
        }
        {this.state.splitStory[9] && charNameArr[1] && this.state.splitStory[9].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(5.329, 4.976, 20.04)} rotation={{x: 0, y: -180, z: 0}}src={this.props.characters[charNameArr[1]]} rotation="0 90 0" height="1" width="1"/>
        }
        {this.state.splitStory[9] && charNameArr[2] && this.state.splitStory[9].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="18 5 0" src={this.props.characters[charNameArr[2]]} rotation="0 -180 0" height="1" width="1"/>
        }
        {this.state.splitStory[9] && charNameArr[3] && this.state.splitStory[9].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="18 7 0" src={this.props.characters[charNameArr[3]]} rotation="0 -180 0" height="1" width="1"/>
        }
        ...
        <Entity primitive="a-plane" material="opacity:0.99" position="1.383 4.375 12.86" rotation="0 7.277 0" scale="1 1 1" side="double" transparent="true" src="http://i.imgur.com/shMHxWL.png" height="1" width="1"/>

        {
          this.state.splitStory[10] && charNameArr[0] && this.state.splitStory[10].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(0.251, 4.56, 12.86)} src={this.props.characters[charNameArr[0]]} rotation="0 7.277 0" height="1" width="1"/>
        }
        {this.state.splitStory[10] && charNameArr[1] && this.state.splitStory[10].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(0.251, 4.56, 12.86)} rotation={{x: 0, y: 7.277, z: 0}} src={this.props.characters[charNameArr[1]]} rotation="0 7.277 0" height="1" width="1"/>
        }
        {this.state.splitStory[10] && charNameArr[2] && this.state.splitStory[10].toLowerCase().indexOf(charNameArr[2]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="20 5 0" src={this.props.characters[charNameArr[2]]} rotation="0 7.277 0" height="1" width="1"/>
        }
        {this.state.splitStory[10] && charNameArr[3] && this.state.splitStory[10].toLowerCase().indexOf(charNameArr[3]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position="20 7 0" src={this.props.characters[charNameArr[3]]} rotation="0 7.277 0" height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[11], align: 'center'}} position={{x: -2.88, y: 2, z: 7.711}} rotation={{x: 0, y: -180, z: 0}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[11] && charNameArr[0] && this.state.splitStory[11].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(-2.88, 2, 7.711)} src={this.props.characters[charNameArr[0]]} rotation="0 90 0" height="1" width="1"/>
        }
        {this.state.splitStory[11] && charNameArr[1] && this.state.splitStory[11].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(-2.88, 2, 7.711)} rotation={{x: 0, y: -180, z: 0}}src={this.props.characters[charNameArr[1]]} rotation="0 90 0" height="1" width="1"/>
        }
        ...
        <Entity text={{value: this.state.splitStory[12], align: 'center'}} position={{x: 24, y: 2, z: -1}} scale={{x: 2, y: 2, z: 2}}/>
        {
          this.state.splitStory[12] && charNameArr[0] && this.state.splitStory[12].toLowerCase().indexOf(charNameArr[0]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posOne(24, 2, -1)} src={this.props.characters[charNameArr[0]]} rotation="0 90 0" height="1" width="1"/>
        }
        {this.state.splitStory[12] && charNameArr[1] && this.state.splitStory[12].toLowerCase().indexOf(charNameArr[1]) > -1 &&
            <Entity primitive="a-plane" material="opacity:0.99999" position={this.posTwo(24, 2, -1)} src={this.props.characters[charNameArr[1]]} rotation="0 90 0" height="1" width="1"/>
        }
