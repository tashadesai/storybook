  ...
  render() {
    return (
      <Scene>
        ...
        <Entity primitive="a-plane" material="opacity:0.99999" position="0 1 0" src={this.props.characters.hansel} rotation="0 90 0" height="1" width="1"/>
        <Entity primitive="a-light" type="ambient" color="#445451"/>
        <Entity primitive="a-light" type="point" intensity="2" position="2 4 4"/>
        <Entity primitive="a-sky" height="2048" radius="30" src="#skyTexture" theta-length="90" width="2048"/>

        <Entity text={{value: 'Sadness', align: 'center'}} position={{x: 0, y: 2, z: -1}}/>
        <Entity text={{value: this.props.storyText, align: 'center'}} position={{x: 0, y: 2, z: -1}}/>
